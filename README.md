...
•	Overview:	3
•	Key Features:	3
1.	Login and Signup:	3
2.	Course and Week Selection:	3
3.	Face Recognition:	4
4.	Attendance Recording:	4
5.	Dynamic GUI:	5
6.	Firebase Integration:	5
7.	WEB Deploying using NGrok:	5
	6
•	Technologies Used:	6
1.	Programming Language:	6
2.	Libraries and Frameworks:	6
3.	Database:	6
4.	Web Framework:	6
5.	Image Processing:	7
6.	Android Development Dependencies:	7
•	How to Use:	7
1.	Login or Signup:	7
2.	Course and Week Selection:	7
3.	Face Recognition:	7
4.	Attendance Recording:	7
•	Benefits:	8
1.	Efficiency:	8
2.	Accuracy:	8
3.	Accessibility:	8
•	Project structure	8
1.	ADD_Faces.py	8
1.	read_random_frames function:	8
2.	create_images_AND_names function:	8
3.	findEncodings function:	9
4.	creatpik function:	9
5.	update_pickle function:	9
6.	main function:	9
2.	FastAPI Server Code	9
1.	Importing Libraries and Modules	9
2.	FastAPI App Setup:	9
3.	Loading Encoded Data:	9
4.	Endpoint for Image Upload:	9
5.	Image Processing and Face Recognition:	10
6.	Face Matching and Result Compilation:	10
7.	Returning Result:	10
8.	Running the FastAPI Server:	10
9.	Additional Notes	10
3.	Firebase Authentication and Face Recognition GUI	10
1.	Importing Libraries and Modules	10
2.	Class: FirebaseAuthenticationApp	10
3.	Additional Notes:	11
4.	Mobile APP	11
1.	Introduction	11
2.	Dependencies	11
3.	Firebase Integration	11
4.	UI Components	11
5.	Camera Integration	12
6.	HTTP POST Request	12
7.	Image Handling	12
...
•	Purpose:
Converts images to RGB format and finds face encodings using the face_recognition library.
•	Parameters:
...
9.	Additional Notes
•	Ensure the necessary libraries (fastapi, uvicorn, face_recognition, cv2, numpy) are installed before running the script.
...
•	onActivityResult: Handles the result of the camera activity and processes the captured image.
6.	HTTP POST Request
